<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Редактирай label</h1>
        <p class="mt-1 text-sm text-gray-500">Обнови информацията за label-а</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <form method="POST" action="index.php?url=label/update" class="space-y-6">
